    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                p.Write(string.Format("client_id={0}&redirect_uri={1}&client_secret={2}&code={3})", "237726383082723", "http://likesbank.apphb.com/webform1.aspx", "0420278b8f5a0985ba21458afac9e257", Request.Params["code"].ToString()));
