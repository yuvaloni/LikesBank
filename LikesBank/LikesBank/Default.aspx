...
<body>
    ...
    <form id="form1" runat="server">
        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="GTW.jpg" style="position:fixed;right:0; top:0; height:5%;width:20%;z-index:4;" OnClick="ImageButton1_Click" />
        <div id ="w1" runat="server" visible="false">
        
         <img src="window.png" style="z-index:4;position:fixed; top:30%; left:20%;width:60%; height:30%;"  />
         ...
         <img src="window.png" style="z-index:2;position:fixed; top:30%; left:20%;width:60%; height:30%;"  />
            <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/close.png" style="z-index:4;position:fixed;top:35%;height:2%;width:2%;left:72%;" OnClick="ImageButton4_Click" />
...
<img src ="bar.jpg" style="top:0;left:0;position:fixed;height:5%;width:100%;z-index:3;" />
    <img src ="Logo.jpg" style="top:0;left:39%; position:fixed;height:5%; width:25%;z-index:4;" />
    </form>
    <div id ="welcome">
